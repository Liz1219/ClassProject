...
(A) .Rmd Line numbers where at least two different data sources are imported:  Lines 38, 49, & 61


(B) .Rmd Line numbers for inspecting data intake:  Lines 45 & 46, 57 & 58, 69 & 70
...
(A) .Rmd Line number(s) for general data wrangling: Lines 74, 88


(B) .Rmd Line number(s) for a join operation: Lines 180 & 214


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent):


(D) .Rmd Line number(s) for use of regular expressions: Line 145


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: Lines 121 & 201
...
(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): Line 228
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  Lines 100, 192, & 237

(B) .Rmd Line number(s) for use of multiple aesthetics:  Line 238

(C) .Rmd Line number(s) for use of layered graphics:  Line 100
